'use client'
import userImg2 from '@/public/images/370in370/Kimchi.webp'
import userImg1 from '@/public/images/370in370/Bibimbap.webp'
import userImg3 from '@/public/images/370in370/Bulgogi.webp'
import 'swiper/css'
...
const userFeedback = [
  ...
  },
  {
    id: 3,
    feedback:
      'Bulgogi, a traditional Korean dish with a history of over a millennium, consists of marinated beef grilled or cooked in a savory blend of soy sauce, garlic, and sesame. With variations ranging from charcoal-grilled to stew-style, bulgogi has become one of the most renowned ambassadors of Korean cuisine worldwide.',
    name: 'Food',
    position: 'Bulgogi',
    img: userImg3,
  },
  ...
  return (
    <section className="pb-14 pt-14 md:pb-16 md:pt-16 lg:pb-[88px] lg:pt-[88px] xl:pb-[100px] xl:pt-[100px]">
      <div className="container relative">
        <h2 className="text-appear mb-9 text-center font-semibold md:mb-14">K-Food</h2>
        <Swiper
